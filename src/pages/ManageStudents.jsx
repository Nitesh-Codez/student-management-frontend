...
// Backend API URL (set in .env as REACT_APP_API_URL=http://localhost:5000)
...
const ManageStudents = () => {
  ...
  const handleAddStudent = async (e) => {
    e.preventDefault();
    if (!name || !studentClass || !password) return alert("Name, class and password are required!");
  ...
  return (
    <div style={page}>
      ...
      <button style={addBtn} onClick={() => setShowForm(true)}>+ Add Student</button>
...
const addBtn = { padding: "10px 20px", background: "#1f3c88", color: "#fff", border: "none", borderRadius: "6px", cursor: "pointer", marginBottom: "20px" };
const saveBtn = { padding: "10px", background: "green", color: "white", border: "none", borderRadius: "6px", width: "100%", marginTop: "10px" };
const closeBtn = { padding: "10px", background: "gray", color: "white", border: "none", borderRadius: "6px", width: "100%", marginTop: "10px" };
const deleteBtn = { padding: "6px 12px", background: "red", color: "white", border: "none", borderRadius: "6px", cursor: "pointer" };
const table = { width: "100%", borderCollapse: "collapse", marginTop: "30px", background: "#fff", border: "1px solid #ccc" };
const th = { border: "1px solid #ccc", padding: "10px", background: "#1f3c88", color: "white", textAlign: "left" };
const td = { border: "1px solid #ccc", padding: "10px" };
...
const modalContent = { background: "#fff", padding: "20px", borderRadius: "10px", width: "350px" };
