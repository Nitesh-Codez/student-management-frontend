...
const AdminFees = () => {
  ...
  return (
    <div style={{ padding: "40px", fontFamily: "Arial, sans-serif", background: "#f9f9f9", minHeight: "100vh" }}>
      <h2 style={{ marginBottom: "25px", color: "#1f3c88", textAlign: "center" }}>Admin - Add Fees</h2>
      ...
      <form onSubmit={handleSubmit} style={{ marginBottom: "40px", display: "flex", flexWrap: "wrap", gap: "15px", justifyContent: "center" }}>
        ...
        <input 
          ...
          required
          style={{ padding: "10px", borderRadius: "8px", border: "1px solid #ccc", minWidth: "120px" }}
        />
        ...
        <button 
          type="submit" 
          style={{ padding: "10px 20px", borderRadius: "8px", background: "#1f3c88", color: "#fff", border: "none", cursor: "pointer" }}
        >
          Add Fee
        </button>
      </form>
